...
import { ADMIN_URL, PACIENTE_URL } from '../../lib/urls';
      ...
      <div className="max-w-[1200px] mx-auto px-7 h-[72px] flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="hidden md:inline-flex items-center gap-2 px-5 py-3 rounded-full text-sm font-semibold text-ink bg-transparent border border-line transition-colors hover:bg-white"
          >
            Login Empresa
          </a>
          <a
            href={`${PACIENTE_URL}/login`}
