...
export default function SidebarPaciente() {
  ...
  return (
    <aside className="w-64 bg-slate-900 text-white flex flex-col min-h-screen sticky top-0 shadow-xl overflow-hidden relative z-20">
      <div className="absolute top-0 right-0 w-40 h-40 bg-primary rounded-full blur-3xl -mr-20 -mt-20 opacity-30 pointer-events-none" />
      ...
      <div className="p-4 border-t border-white/10 relative z-10">
        <button
          ...
          className="flex items-center gap-2 text-xs text-red-400 hover:text-red-300 transition-colors w-full px-2 py-2 font-bold"
        >
