  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Link href="/portal/historico" className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:border-[#007178]/30 hover:-translate-y-1 transition-all group block">
        ...
        <Link href="/portal/guia" className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:border-teal-200 hover:-translate-y-1 transition-all group block">
