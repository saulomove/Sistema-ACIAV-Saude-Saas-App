...
const menuItems = [
  { name: 'Minha Carteirinha', icon: CreditCard, href: '/portal' },
  { name: 'Dependentes', icon: Users, href: '/portal/dependentes' },
  ...
  return (
    <>
      ...
      <aside className={clsx(
        ...
        <div className="p-4 border-t border-white/20 relative z-10 safe-bottom">
          <button
